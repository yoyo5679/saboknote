                    ...
                    <div class="step-card beautiful-card" style="padding:20px; border-color:#e0f2fe;">
                        ...
                        <div style="background:rgba(255,255,255,0.7); backdrop-filter:blur(10px); border-radius:20px; padding:20px; margin-bottom:24px; border:1px solid rgba(226,232,240,0.8); box-shadow:0 10px 15px -3px rgba(0,0,0,0.05);">
                            ...
                            <div style="margin-top:16px;">
                                <label style="font-size:0.8rem; color:#1e293b; font-weight:800; display:block; margin-bottom:8px;">가산 선택</label>
                                <div style="display:flex; gap:6px;">
                                    <button id="ltc-gasan-0" onclick="setLtcGasan(0)" style="flex:1; padding:10px 0; border-radius:8px; border:1px solid #e2e8f0; background:#5cb85c; color:white; font-size:0.75rem; font-weight:700; cursor:pointer; transition:all 0.2s; white-space:nowrap; letter-spacing:-0.5px;">기본(0%)</button>
                                    <button id="ltc-gasan-30" onclick="setLtcGasan(30)" style="flex:1.5; padding:10px 0; border-radius:8px; border:1px solid #e2e8f0; background:#f8fafc; color:#475569; font-size:0.75rem; font-weight:700; cursor:pointer; transition:all 0.2s; white-space:nowrap; letter-spacing:-0.5px;">심야, 휴일(30%)</button>
                                    <button id="ltc-gasan-50" onclick="setLtcGasan(50)" style="flex:1.5; padding:10px 0; border-radius:8px; border:1px solid #e2e8f0; background:#f8fafc; color:#475569; font-size:0.75rem; font-weight:700; cursor:pointer; transition:all 0.2s; white-space:nowrap; letter-spacing:-0.5px;">유급휴일(50%)</button>
                                </div>
