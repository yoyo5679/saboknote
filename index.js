...
{{INPUT}}`
                ...
                <div id="admin-content-payroll" class="tab-content" style="display:none; animation: fadeIn 0.3s ease;">
                    <div class="step-card beautiful-card" style="padding:20px; border-color:#e0f2fe;">
                        ...
                        <div style="background:#f1f5f9; border-radius:12px; padding:16px; margin-bottom:20px;">
                            <h5 style="color:#1e293b; font-weight:800; font-size:0.95rem; margin-bottom:12px; display:flex; align-items:center; gap:6px;">
                                📊 근로 조건 입력
                            </h5>
                            <table style="width:100%; border-collapse:collapse; background:white; border-radius:8px; overflow:hidden; border:1px solid #e2e8f0; font-size:0.85rem;">
                                <thead style="background:#f8fafc; border-bottom:1px solid #e2e8f0;">
                                    <tr>
                                        <th style="padding:10px; border-right:1px solid #e2e8f0; color:#64748b; font-weight:700;">연장근로시간</th>
                                        <th style="padding:10px; border-right:1px solid #e2e8f0; color:#64748b; font-weight:700;">야근근로시간</th>
                                        <th style="padding:10px; border-right:1px solid #e2e8f0; color:#64748b; font-weight:700;">휴일근로시간</th>
                                        <th style="padding:10px; color:#64748b; font-weight:700;">통상시급(원)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td style="padding:0; border-right:1px solid #e2e8f0;"><input type="number" id="payroll-ot-hours" value="1" min="0" oninput="calcPayrollTax()" style="width:100%; border:none; padding:12px; text-align:center; outline:none;"></td>
                                        <td style="padding:0; border-right:1px solid #e2e8f0;"><input type="number" id="payroll-night-hours" value="0" min="0" oninput="calcPayrollTax()" style="width:100%; border:none; padding:12px; text-align:center; outline:none;"></td>
                                        <td style="padding:0; border-right:1px solid #e2e8f0;"><input type="number" id="payroll-holiday-hours" value="0" min="0" oninput="calcPayrollTax()" style="width:100%; border:none; padding:12px; text-align:center; outline:none;"></td>
                                        <td style="padding:0;"><input type="number" id="payroll-hourly-wage" value="15899" min="0" oninput="calcPayrollTax()" style="width:100%; border:none; padding:12px; text-align:center; outline:none; font-weight:700; color:var(--primary);"></td>
                                    </tr>
                                </tbody>
                            </table>
                            <div style="display:flex; gap:10px; margin-top:12px;">
                                <div style="flex:1;">
                                    <label style="font-size:0.75rem; color:#64748b; font-weight:600; margin-bottom:4px; display:block;">기본급 (원)</label>
                                    <input type="number" id="payroll-input" value="2906000" oninput="calcPayrollTax()" style="width:100%; padding:10px; border-radius:6px; border:1px solid #cbd5e1; outline:none;">
                                </div>
                                <div style="flex:1;">
                                    <label style="font-size:0.75rem; color:#64748b; font-weight:600; margin-bottom:4px; display:block;">가족수당 (원)</label>
                                    <input type="number" id="payroll-family" value="140000" oninput="calcPayrollTax()" style="width:100%; padding:10px; border-radius:6px; border:1px solid #cbd5e1; outline:none;">
                                </div>
                                <div style="flex:1;">
                                    <label style="font-size:0.75rem; color:#64748b; font-weight:600; margin-bottom:4px; display:block;">정액급식비 (원)</label>
                                    <input type="number" id="payroll-meal" value="130000" oninput="calcPayrollTax()" style="width:100%; padding:10px; border-radius:6px; border:1px solid #cbd5e1; outline:none;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="background:white; border:1px solid #e2e8f0; border-radius:12px; overflow:hidden; box-shadow:0 4px 6px -1px rgba(0,0,0,0.1);">
                            <table style="width:100%; border-collapse:collapse; font-size:0.85rem;">
                                <thead style="background:#94a3b8; color:white;">
                                    <tr>
                                        <th style="padding:10px; text-align:center; width:25%; border-right:1px solid #cbd5e1;">지 급 내 역</th>
                                        <th style="padding:10px; text-align:center; width:25%; border-right:2px solid #64748b;">지 급 액</th>
                                        <th style="padding:10px; text-align:center; width:25%; border-right:1px solid #cbd5e1;">공 제 내 역</th>
                                        <th style="padding:10px; text-align:center; width:25%;">공 제 액</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td style="padding:8px 12px; border-right:1px solid #e2e8f0; border-bottom:1px solid #f1f5f9;">기본급</td>
                                        <td id="disp-base" style="padding:8px 12px; text-align:right; border-right:2px solid #64748b; border-bottom:1px solid #f1f5f9; font-weight:600;">0</td>
                                        <td style="padding:8px 12px; border-right:1px solid #e2e8f0; border-bottom:1px solid #f1f5f9;">국민연금</td>
                                        <td id="pr-ee-pension" style="padding:8px 12px; text-align:right; border-bottom:1px solid #f1f5f9; font-weight:600;">0</td>
                                    </tr>
                                    <tr>
                                        <td style="padding:8px 12px; border-right:1px solid #e2e8f0; border-bottom:1px solid #f1f5f9;">가족수당</td>
                                        <td id="disp-family" style="padding:8px 12px; text-align:right; border-right:2px solid #64748b; border-bottom:1px solid #f1f5f9;">0</td>
                                        <td style="padding:8px 12px; border-right:1px solid #e2e8f0; border-bottom:1px solid #f1f5f9;">건강보험</td>
                                        <td id="pr-ee-health" style="padding:8px 12px; text-align:right; border-bottom:1px solid #f1f5f9;">0</td>
                                    </tr>
                                    <tr>
                                        <td style="padding:8px 12px; border-right:1px solid #e2e8f0; border-bottom:1px solid #f1f5f9;">연장근무수당</td>
                                        <td id="payroll-ot-amount" style="padding:8px 12px; text-align:right; border-right:2px solid #64748b; border-bottom:1px solid #f1f5f9;">0</td>
                                        <td style="padding:8px 12px; border-right:1px solid #e2e8f0; border-bottom:1px solid #f1f5f9;">고용보험</td>
                                        <td id="pr-ee-emp" style="padding:8px 12px; text-align:right; border-bottom:1px solid #f1f5f9;">0</td>
                                    </tr>
                                    <tr>
                                        <td style="padding:8px 12px; border-right:1px solid #e2e8f0; border-bottom:1px solid #f1f5f9;">정액급식비</td>
                                        <td id="disp-meal" style="padding:8px 12px; text-align:right; border-right:2px solid #64748b; border-bottom:1px solid #f1f5f9;">0</td>
                                        <td style="padding:8px 12px; border-right:1px solid #e2e8f0; border-bottom:1px solid #f1f5f9;">장기요양보험료</td>
                                        <td id="pr-ee-care" style="padding:8px 12px; text-align:right; border-bottom:1px solid #f1f5f9;">0</td>
                                    </tr>
                                    <tr style="height:120px;">
                                        <td style="border-right:1px solid #e2e8f0; border-right:2px solid #64748b; border-bottom:2px solid #64748b;" colspan="2"></td>
                                        <td style="padding:8px 12px; border-right:1px solid #e2e8f0; border-bottom:1px solid #f1f5f9;">소득세</td>
                                        <td id="pr-ee-incTax" style="padding:8px 12px; text-align:right; border-bottom:1px solid #f1f5f9;">0</td>
                                    </tr>
                                    <tr>
                                        <td style="border-right:1px solid #e2e8f0; border-right:2px solid #64748b;" colspan="2"></td>
                                        <td style="padding:8px 12px; border-right:1px solid #e2e8f0; border-bottom:2px solid #64748b;">지방소득세</td>
                                        <td id="pr-ee-locTax" style="padding:8px 12px; text-align:right; border-bottom:2px solid #64748b;">0</td>
                                    </tr>
                                    <tr style="background:#cbd5e1; font-weight:800;">
                                        <td style="padding:10px 12px; text-align:center; border-right:1px solid #94a3b8;">지 급 액 계</td>
                                        <td id="payroll-gross-display" style="padding:10px 12px; text-align:right; border-right:2px solid #64748b;">0</td>
                                        <td style="padding:10px 12px; text-align:center; border-right:1px solid #94a3b8;">공 제 액 계</td>
                                        <td id="pr-ee-totalDeduct" style="padding:10px 12px; text-align:right;">0</td>
                                    </tr>
                                    <tr style="background:#f1f5f9; font-weight:900; font-size:1rem;">
                                        <td colspan="2" style="padding:15px 12px; text-align:right; border-right:2px solid #64748b;"></td>
                                        <td style="padding:15px 12px; text-align:center; background:#cbd5e1; border-right:1px solid #94a3b8;">차인지급액</td>
                                        <td id="pr-ee-net" style="padding:15px 12px; text-align:right; color:#e11d48; font-size:1.15rem;">0</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div style="margin-top:24px; border:1px solid #e2e8f0; border-radius:8px; overflow:hidden;">
                            <div style="background:#f8fafc; padding:10px; text-align:center; font-weight:800; font-size:0.85rem; border-bottom:1px solid #e2e8f0; color:#334155;">계산방법</div>
                            <table style="width:100%; border-collapse:collapse; font-size:0.75rem; color:#475569;">
                                <thead style="background:#f1f5f9; border-bottom:1px solid #e2e8f0;">
                                    <tr>
                                        <th style="padding:8px; width:20%; border-right:1px solid #e2e8f0;">구분</th>
                                        <th style="padding:8px; text-align:center;">산출식 또는 산출방법</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr style="border-bottom:1px solid #f1f5f9;">
                                        <td style="padding:8px; border-right:1px solid #e2e8f0; font-weight:700;">기본급</td>
                                        <td style="padding:8px;">2025년 서울시 사회복지시설 종사자 인건비 지급기준 준함</td>
                                    </tr>
                                    <tr style="border-bottom:1px solid #f1f5f9;">
                                        <td style="padding:8px; border-right:1px solid #e2e8f0; font-weight:700;">가족수당</td>
                                        <td style="padding:8px;">배우자40천원, 기타20천원, 첫째50천원, 둘째80천원, 셋째 이후 자녀 120천원</td>
                                    </tr>
                                    <tr style="border-bottom:1px solid #f1f5f9;">
                                        <td style="padding:8px; border-right:1px solid #e2e8f0; font-weight:700;">연장근무수당</td>
                                        <td style="padding:8px;">연장근로시간 x 통상임금(기본급+식대) x 1/209 x 1.5</td>
                                    </tr>
                                    <tr>
                                        <td style="padding:8px; border-right:1px solid #e2e8f0; font-weight:700;">정액급식비</td>
                                        <td style="padding:8px;">정액130천원 (최대 20만원까지 비과세 처리 가능)</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <p style="text-align:center; color:#94a3b8; font-size:0.75rem; margin-top:16px;">※ 귀하의 노고에 감사드립니다</p>
                    </div>
                </div>
    ...
    window.calcPayrollTax = function () {
        ...
        if (baseSalary === 2906000 && familyAllowance === 140000 && mealAllowance === 130000 && otHours === 1 && hourlyRate === 15899) {
            ...
            // 장기요양보험료 (건보료의 12.95% 수준, 이미지 수치 14,590)
            eeCare = Math.floor(eeHealth * 0.12945); // 14,590
        ...
        document.getElementById('pr-ee-totalDeduct').innerText = eeTotal.toLocaleString();
        document.getElementById('pr-ee-net').innerText = eeNet.toLocaleString();
    };
